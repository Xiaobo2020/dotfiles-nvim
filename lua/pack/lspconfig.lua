...
M.config = function()
	...
	G.lsp.handlers["textDocument/publishDiagnostics"] = G.lsp.with(G.lsp.diagnostic.on_publish_diagnostics, {
		underline = true,
	...
	require("mason-lspconfig").setup_handlers({
		...
		tsserver = function()
			require("typescript").setup({
				server = G.tbl_extend("force", lsp_configs, {
					init_options = {
						preferences = {
				...
				settings = {
					Lua = {
						...
						workspace = {
							...
							library = G.api.nvim_get_runtime_file("", true),
